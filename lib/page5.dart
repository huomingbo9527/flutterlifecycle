...
class Page5 extends StatefulWidget {
  Page5({Key key, this.title = "Page5"}) : super(key: key);
...
class _Page5State extends State<Page5> with WidgetsBindingObserver{
  int _counter = 0;
  @override
  void initState() {
    super.initState();
    print("Page5   initState ----------------------- ");
  ...
  void didChangeDependencies() {
    print("Page5   didChangeDependencies ");
  ...
  void didUpdateWidget(Page5 oldWidget) {
    ...
    print("Page5   didUpdateWidget  $oldWidget");
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    print("Page5   didChangeAppLifecycleState  $state");
